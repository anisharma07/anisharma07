...
<!-- Dynamic Terminal Typing Subtitle -->
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/ACADEMICS-NIT%20HAMIRPUR%20(9.38%20GPA)-8a2be2?style=flat-square&logo=academia&logoColor=white" alt="Academics" />
  <img src="https://img.shields.io/badge/LEETCODE-TOP%205%25%20(700%2B%20SOLVED)-FFA116?style=flat-square&logo=leetcode&logoColor=black" alt="LeetCode" />
...
| :--- | :--- | :--- | :--- |
| **ScheduleX** | `React Native` `Gemini AI` `Firebase` | LLM-driven timetable orchestration engine accelerating scheduling by 70% with offline sync. | [📦 Repo](https://github.com/anisharma07/React-native-attendance-app) • [📥 APK](https://github.com/anisharma07/React-native-attendance-app/releases/download/v1.0.3/app-release.apk) |
| **Socialcalc MCP** | `MCP Protocol` `TypeScript` `AWS S3` | Model Context Protocol server enabling LLMs to query and manipulate spreadsheets in real time. | [🏢 C4GT Org](https://github.com/anisharma07) |
| **nftOS Marketplace** | `Next.js` `Solidity` `IPFS` `MongoDB` | L2 blockchain digital asset platform with sub-second MongoDB sync cutting query latency by 90%. | [🌐 Platform](https://nftos.in) |
...
| **Atmospheric Site** | `React` `TypeScript` `Web Audio API` | Immersive web experience with procedural sound synthesis, custom particle canvas, and AI Assistant. | [🌐 Live](https://anirudh-sharma.fun) • [📦 Repo](https://github.com/anisharma07) |
